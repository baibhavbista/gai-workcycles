      ...
      <div className="max-w-md mx-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-xl font-bold text-gray-900">Session Intentions</h1>
          </div>
          <VoiceRecorder onComplete={handleVoiceComplete} />
        </div>
        
        <p className="text-gray-600 text-center mb-6">
          Take a moment to clarify your goals and set the foundation for a productive session.
        </p>
        
        <form onSubmit={handleSubmit} className="space-y-6">
          {/* Main objective */}
          <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
            <h3 className="font-semibold text-gray-900 mb-4">Set Your Intentions</h3>
            <p className="text-gray-600 text-sm mb-4">
              These questions help you focus on what matters most for this work session.
            </p>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-3">
                ...
                />
                <label htmlFor="concrete" className="text-gray-700">
                  <span className="font-medium">Is this concrete / measurable or subjective / ambiguous?</span>
                  <div className="text-sm text-gray-500">
                    Turn on if your goal has clear, measurable outcomes
                  </div>
                </label>
              </div>
            </div>
